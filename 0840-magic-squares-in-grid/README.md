...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> grid = [[4,3,8,4],[9,5,1,9],[2,7,6,2]]
...
<pre style="background-color: rgb(193, 230, 198);"><strong>Input:</strong> grid = [[8]]
